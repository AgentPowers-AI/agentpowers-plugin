...
/** Escape characters that could break markdown formatting in titles. */
function sanitizeTitle(text) {
    return text.replace(/[\r\n]/g, " ").replace(/[[\]()]/g, "\\$&");
}
/** Strip backticks from values displayed inside backtick fences. */
...
export function formatSecurityOutcome(outcome) {
...
export function formatTrustLevel(level) {
...
export function formatSkillDetail(detail) {
    const lines = [
